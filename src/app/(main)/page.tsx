...
const Home = () => {
  ...
  const engineeringDepartments = [
    {
      ...
      stats: isMounted ? departmentStats.computer : { students: 3, resources: 8, subjects: 12 }
    },
    {
      id: 'civil',
      ...
      stats: isMounted ? departmentStats.civil : { students: 1, resources: 1, subjects: 4 }
    },
    {
      id: 'chemical',
      ...
      stats: isMounted ? departmentStats.chemical : { students: 12, resources: 4, subjects: 8 }
    },
    {
      id: 'electrical',
      ...
      stats: isMounted ? departmentStats.electrical : { students: 8, resources: 3, subjects: 10 }
    },
    {
      id: 'mechanical',
      ...
      stats: isMounted ? departmentStats.mechanical : { students: 5, resources: 2, subjects: 9 }
    }
  ]
  ...
  const stats = isMounted ? [
    ...
    { icon: Users, label: 'Active Students', value: '3+' },
    { icon: BookOpen, label: 'Resources', value: '5+' },
    { icon: Download, label: 'Downloads', value: '195+' },
